...
def GenerateTopology():
    ...
    net.addLink(h1, r1,  1, 1, bw = 10)
    net.addLink(h2, r1,  1, 2, bw = 10)
    net.addLink(h3, r2,  1, 1, bw = 10)
    net.addLink(h4, r3,  1, 2, bw = 10)
 
    net.addLink(r1, b1,  3, 1, bw = 10)
    net.addLink(r2, b2,  2, 1, bw = 10)
    net.addLink(r3, b3,  1, 2, bw = 10)
    net.addLink(r4, b4,  1, 2, bw = 10)
    net.addLink(r4, b5,  2, 2, bw = 10)
    net.addLink(r4, b6,  3, 1, bw = 10)
    net.addLink(r5, b7,  1, 2, bw = 10)
    net.addLink(r5, b8,  2, 1, bw = 10)
    net.addLink(r5, h5,  3, 1, bw = 10)
    net.addLink(r6, b9,  1, 2, bw = 10)
    net.addLink(r6, b10, 2, 1, bw = 10)

    net.addLink(b1, b4,  2, 1, bw = 10)
    net.addLink(b2, b5,  2, 1, bw = 10)
    net.addLink(b6, b7,  2, 1, bw = 10)
    net.addLink(b8, b9,  2, 1, bw = 10)
    net.addLink(b3, b10, 1, 2, bw = 10)
